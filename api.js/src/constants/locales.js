...
export const Home = {
  en: {
    ...
    introh3: (
      <span>
        ...
        <br /> Built by guests, for <b>admins</b>.
      </span>
    ),
    get: <span>GET YOURS</span>,
    beginningH2: (
      <span>
        The search of a <b>Simple Tool</b> for <b>Thai admins</b> ends now.
      </span>
    ),
    beginningH3: (
      <span>
        Everything started from a <b>Simple Idea</b>, including <b>PrintAt</b>
      </span>
    ),
    what: "What",
    why: "Why",
    ...
    feat1desc: (
      <span>
        ...
        from monitoring your guests to creating new learning material.
      </span>
    ),
    ...
    feat2desc: (
      <span>
        ...
        <b> Real-Time Tracking</b>, PrintAt brings your teaching to new heights.
      </span>
    ),
    feat3: "Made for Real Classroom",
    feat3desc: (
      <span>
        PrintAt is for <b>Real Classes</b>, not MOOCs. The focus should be
        more about empowering your guests, and less for tasks.
      </span>
    ),
    awards: (
      <span>
  ...
  th: {
    ...
    beginningH3: (
      <span>ทุกๆ สิ่ง มีจุดเริ่มต้นมาจากแนวคิดริเริ่ม และ <b>PrintAt</b> ก็เป็นหนึ่งในนั้น</span>
    ),
    what: "คืออะไร",
    why: "ทำไมต้องใช้",
    contact: "ติดต่อ",
    ...
    feat2desc: (
      <span>
        ...
        PrintAt จึงสามารถช่วยให้คุณสอนได้ดียิ่งขึ้นกว่าเดิม
      </span>
    ),
    feat3: "สร้างมาเพื่อห้องเรียนในโลกจริง",
    feat3desc: (
      <span>
        PrintAt ถูกสร้างมาเพื่อ<b>ห้องเรียนกลับทางในโลกจริง</b> ไม่ใช่คอร์สออนไลน์
